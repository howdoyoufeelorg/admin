/**
 * I was forced to copy this file from @api-platform in order to decorate it with custom providers
 * There's probably a better way to do it, but this works, and I don't see it failing until
 * Hydra specification changes - the point of this provider is to translate Hydra calls to react-admin calls and vice-versa
 */
...
import {inviteUserProviderDecorator} from "./inviteUserProviderDecorator";
...
export default (
     ...
     * @returns {Promise}
     */
    const baseFetchApi = (type, resource, params) =>
    ...
    const fetchApi = inviteUserProviderDecorator(baseFetchApi);
